...
function wordCounter(sentence) {
  let obj = {};
  // создать объект который содержит все необходимые ключи
...
function createHashTags(arr) {
  ...
  arr.forEach(function(elem) {
    // obj[ '294814e3-4c89-428f-b0c9-da5c4c37ea5e' ] = 1
    // { '294814e3-4c89-428f-b0c9-da5c4c37ea5e': 1 }
    obj[elem._id] = elem.company; // ASIMILINE
  });
  return obj;
}
...
function uniqueElements(arr) {
  ...
  //   console.log('index of elem: ', arr.indexOf(elem));
  //   console.error('настоящие индекс: ', index);
